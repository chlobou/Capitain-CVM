...
public static class PlayerDataJson
{
    ...
    {
        PlayerDataToJson pdtj = new PlayerDataToJson(data.Vie, data.Energie, data.Score, data.VolumeGeneral, data.VolumeMusique, data.VolumeEffet, data.ListeCoffreOuvert, data.collectables, data.maxLevelReached);
    ...
    public static PlayerData ReadJson(string json)
    {
        ...
        return new PlayerData(pdtj.vie, pdtj.energie, pdtj.score, pdtj.volumeGeneral, pdtj.volumeMusique, pdtj.volumeEffet, ChestList: chests, maxLevelReached: pdtj.MaxLevel, collectables: pdtj.collectable);
    }
}
